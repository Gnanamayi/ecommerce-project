    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top py-3">
      ...
      <section class="my-5 py-5">
        ...
        <div class="mx-auto container text-center">
            ...
            <p>Total Payment: Rs.<?php if(isset($_SESSION['total']) ) {echo $_SESSION['total']; } ?>
            <?php if (isset($_SESSION['total']) && $_SESSION['total']!=0 ) { ?>
        </p><input type="submit" class="btn btn-primary" value="Pay Now" /><?php } 
        else { ?>
        <p>You dont have an order</p>
        <?php } ?>
        <?php if (isset($_GET['order_status']) && $_GET['order_status']=="not_paid") { ?>
          </p><input type="submit" class="btn btn-primary" value="Pay Now" ><?php }?>
